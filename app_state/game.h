...
public:
    ...
    Mix_Chunk *bullet_1 = NULL;
    Mix_Chunk *bullet_2 = NULL;
    Mix_Chunk *bullet_3 = NULL;
    Mix_Chunk *show_new_bonus = NULL;
    Mix_Chunk *add_new_tanklife = NULL;
    Mix_Chunk *take_bonus = NULL;
    Mix_Chunk *destroy_bot = NULL;    
    Mix_Chunk *destroy_player = NULL;
    Mix_Chunk *score_end = NULL;
    Mix_Chunk *start_game = NULL;
