...
${OBJECTDIR}/app_state/game.o: app_state/game.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app_state/game.o app_state/game.cpp

${OBJECTDIR}/app_state/menu.o: app_state/menu.cpp
	${MKDIR} -p ${OBJECTDIR}/app_state
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app_state/menu.o app_state/menu.cpp

${OBJECTDIR}/app_state/scores.o: app_state/scores.cpp
	${MKDIR} -p ${OBJECTDIR}/app_state
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/app_state/scores.o app_state/scores.cpp

${OBJECTDIR}/appconfig.o: appconfig.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/appconfig.o appconfig.cpp

${OBJECTDIR}/engine/engine.o: engine/engine.cpp
	${MKDIR} -p ${OBJECTDIR}/engine
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/engine.o engine/engine.cpp

${OBJECTDIR}/engine/renderer.o: engine/renderer.cpp
	${MKDIR} -p ${OBJECTDIR}/engine
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/renderer.o engine/renderer.cpp

${OBJECTDIR}/engine/spriteconfig.o: engine/spriteconfig.cpp
	${MKDIR} -p ${OBJECTDIR}/engine
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/engine/spriteconfig.o engine/spriteconfig.cpp
...
${OBJECTDIR}/objects/bonus.o: objects/bonus.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objects/bonus.o objects/bonus.cpp

${OBJECTDIR}/objects/brick.o: objects/brick.cpp
	${MKDIR} -p ${OBJECTDIR}/objects
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objects/brick.o objects/brick.cpp

${OBJECTDIR}/objects/bullet.o: objects/bullet.cpp
	${MKDIR} -p ${OBJECTDIR}/objects
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objects/bullet.o objects/bullet.cpp

${OBJECTDIR}/objects/eagle.o: objects/eagle.cpp
	${MKDIR} -p ${OBJECTDIR}/objects
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objects/eagle.o objects/eagle.cpp

${OBJECTDIR}/objects/enemy.o: objects/enemy.cpp
	${MKDIR} -p ${OBJECTDIR}/objects
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objects/enemy.o objects/enemy.cpp

${OBJECTDIR}/objects/object.o: objects/object.cpp
	${MKDIR} -p ${OBJECTDIR}/objects
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objects/object.o objects/object.cpp

${OBJECTDIR}/objects/player.o: objects/player.cpp
	${MKDIR} -p ${OBJECTDIR}/objects
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objects/player.o objects/player.cpp

${OBJECTDIR}/objects/tank.o: objects/tank.cpp
	${MKDIR} -p ${OBJECTDIR}/objects
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/objects/tank.o objects/tank.cpp
