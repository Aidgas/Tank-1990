...
public:
    ...
    Mix_Chunk *move_tank        = NULL; // loop
    Mix_Chunk *idle_tank        = NULL; // loop
    Mix_Chunk *destroy_player   = NULL;
    Mix_Chunk *destroy_bot      = NULL;
    Mix_Chunk *bullet_3         = NULL;
    
    int move_tank_play_channel = -1
     ...
     */
    virtual Bullet* fire(bool is_player = false);
    /**
    ...
    void stop_sound_tank();
    void init_sounds();
    void init_sounds2();
    void play_sound_destroy_bot();
    void free_sound();
