...
string AppConfig::texture_path = "../../data/texture.png";
string AppConfig::levels_path  = "../../data/levels/";
string AppConfig::sounds_path  = "../../data/sounds/";
string AppConfig::font_name    = "../../data/prstartk.ttf";
...
#else
    #define P1_FIRE_KEY SDL_SCANCODE_LCTRL
